...
#t_win_start_odor = 0.
t_win_start_odor_encoding = -0.4
t_win_stop_odor_encoding = 3.0
t_win_start_rest_encoding = -3.8
t_win_stop_rest_encoding = -3.0

t_win_start_odor_recall = -0.5
t_win_stop_odor_recall = 3.0
t_win_start_rest_recall = 0.5
t_win_stop_rest_recall = 1.5

subject_ids = ['FERJ','SEMC','CHAF','VACJ', 'PIRJ', 'LEFC',]
#subject_ids = ['PIRJ', 'VACJ']
#~ subject_ids = ['VACJ', 'PIRJ', 'LEFC']
#thr_nb_artefacts = [200,200,200,200,200,200,200]
#thr_nb_artefacts = [500,500,500,500,500,500,500]
thr_nb_artefacts = [0,0,0,0,0,0,0]
...
trial_R_conds = ['all_recall']

trial_E_conds = ['all_encoding']
