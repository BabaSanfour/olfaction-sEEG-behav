...
path_to_save = join(path, 'Visbrain/All_subjects/Test/')
f_form = '{}_sources_{}_odor_EpiScore_Expi_None.npz'
f_form = join(path_npz, f_form)
f_form_save = join(path_to_save, '{}_proj_'+feat+'_corr_05_{}_{}_{}_{}_EpiScore_None.png')
cb_save = join(path_to_save, 'Proj_'+feat+'_all_Brain_CB_EpiScore.png')
###############################################################################
