...
for freq, min_sig, method in product(freqs,min_sigs, methods):
	...
	for win in wins:
		...
		da, power = arch_sig['s_da'], (arch_sig['s_elec_pow1']-arch_sig['s_elec_pow0'])*100#/arch_sig['s_elec_pow0'])*100
		print(da.shape, power.shape)
		...
		data = pow_all
		print(data.shape, idx_all.shape, data)
		# =============================================================================
		...
		b_obj_l2.project_sources(s_obj_l2,'modulation', cmap='jet', clim=(-40,40),
			radius=radius)
