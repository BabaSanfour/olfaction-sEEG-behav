...
for freq, min_sig, method in product(freqs,min_sigs, methods):
	...
	for win in wins:
		...
		idx_all, time_all = np.array([]), np.array([])
		...
		b_obj_r.project_sources(s_obj_r,'modulation', cmap='plasma', clim=(-1000,2500),
			radius=radius)
		...
		b_obj_r2.project_sources(s_obj_r2,'modulation', cmap='plasma', clim=(-1000,2500),
			radius=radius)
		...
		b_obj_l.project_sources(s_obj_l,'modulation', cmap='plasma', clim=(-1000,2500),
			radius=radius)
		...
		b_obj_l2.project_sources(s_obj_l2,'modulation', cmap='plasma', clim=(-1000,2500),
			radius=radius)
