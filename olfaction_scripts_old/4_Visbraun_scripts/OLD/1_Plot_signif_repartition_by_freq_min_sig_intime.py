...
for freq, bsl, th, min_sig, method in product(freqs,bsls,ths,min_sigs, methods):
	...
	for i,win in enumerate(wins):
		...
		xyz = arch_sig['s_xyz']
		s_obj_c = SourceObj('modulation', xyz, mask=mask)
		b_obj_top.project_sources(s_obj_c,'repartition', cmap=cmap, clim=(clim_min,clim_max),radius=12.)
		...
		b_obj_bot.project_sources(s_obj_b,'repartition', cmap=cmap, clim=(clim_min,clim_max),radius=12.)
		...
		b_obj_r.project_sources(s_obj_r,'repartition', cmap=cmap, clim=(clim_min,clim_max),radius=12.)
		...
		b_obj_r2.project_sources(s_obj_r2,'repartition', cmap=cmap, clim=(clim_min,clim_max),radius=12.)
		...
		b_obj_l.project_sources(s_obj_l,'repartition', cmap=cmap, clim=(clim_min,clim_max),radius=12.)
		...
		b_obj_l2.project_sources(s_obj_l2,'repartition', cmap=cmap, clim=(clim_min,clim_max),radius=12.)
