...
def _cleanData(pathdata, suj):
    ...
    """
    # Import file :
    file = '{suj}_R123_OrdreMFconcat_trigg00.mat'
...
if __name__ == '__main__':
    ...
    pathdata = r'C:\Users\Anne-Lise\Dropbox\Intra_EM\2_eeg2mat\data_mat\2-Retrieval_all\concat_files' # path where data are located
