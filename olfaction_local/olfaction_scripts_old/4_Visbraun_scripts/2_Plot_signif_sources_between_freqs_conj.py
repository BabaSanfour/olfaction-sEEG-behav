...
s_obj_c3 = SourceObj('Color', xyz_sig_freqs[3], data=data_freqs[3])
s_obj_c4 = SourceObj('Color', xyz_sig_freqs[4], data=data_freqs[4])
...
b_obj_top.project_sources(s_obj_c2, cmap='winter', to_overlay=2, clim=(0., 1.))
b_obj_top.project_sources(s_obj_c3, cmap='cool', to_overlay=3, clim=(0., 1.))
b_obj_top.project_sources(s_obj_c4, cmap='spring', to_overlay=4, clim=(0., 1.))
s_obj_c0.visible_obj = False
s_obj_c1.visible_obj = False
s_obj_c2.visible_obj = False
s_obj_c3.visible_obj = False
s_obj_c4.visible_obj = False
sc.add_to_subplot(s_obj_c0, row=0, col=0)
sc.add_to_subplot(s_obj_c1, row=0, col=0)
sc.add_to_subplot(s_obj_c2, row=0, col=0)
sc.add_to_subplot(s_obj_c3, row=0, col=0)
sc.add_to_subplot(s_obj_c4, row=0, col=0)
sc.preview()
