...
PATH_0 = "/media/karim/Datas4To/1_Analyses_Intra_EM_Odor/Olfacto/"
PATH = PATH_0+"feature/0_Power_Encoding_EpiPerf_LowHigh/"
SAVE_PATH = PATH_0+"classified/LDA_Power_E_EpiPerf_LowHigh/"
...
if __name__ == "__main__":
    ...
    for su in subjects:
        conds = ['low','high']
        freq_names = ['theta','alpha']#['theta','alpha','beta','gamma']
        freq = 1
        ...
        LDA_E_R_Pow(su,elec,freq)

        # Parallel(n_jobs=-1)(
        #     delayed(LDA_E_R_Pow)(su,elec,freq)
        #     ) #for elec,freq in product(range(nelecs),range(4)